...
public class PlainTextLineNumber extends JPanel
		implements CaretListener, DocumentListener, AdjustmentListener, Disposable
{
	...
	public PlainTextLineNumber(JTextArea component, JScrollPane scrollPane) {
		this(component, scrollPane, 3);
	}

	public PlainTextLineNumber(JTextArea component, JScrollPane scrollPane, int minimumDigits) {
	...
	protected void paintComponent(Graphics g) {
		...
		try {
			...
			int caretPosition = component.getLineOfOffset(component.getCaretPosition())+1;
	...
	protected int getLineNumberFor(int offset) {
		try {
			return component.getLineOfOffset(offset)+1;
		} catch (BadLocationException e) {
			return -1;
		}
	}
