...
public class ThemeListenerManager implements Disposable {
    ...
    public void dispose() {
        if(listeners != null) {
            ...
            GuardianWindow.statusBar.setStatus(new Status(Status.ERROR, "ERROR: Reused ThemeListenerManager '" + source + "'. Please report to Energyxxer. More details in the console."));
